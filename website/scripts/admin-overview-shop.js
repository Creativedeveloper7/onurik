...
import { getCatalog } from "../shop/products.js";
...
fill("admin-shop-products-note", catalog.length + " in catalog · " + live + " live on the shop");
...
fill("admin-shop-revenue-note", stats.revenue ? "Excludes cancelled orders" : "Revenue appears after a confirmed checkout.");
